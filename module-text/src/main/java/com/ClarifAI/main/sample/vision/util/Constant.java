...
package com.ClarifAI.main.sample.vision.util;
...
public class Constant {
    ...
    public static final String SUPER_RESOLUTION_TYPE = "super_resolution_type";
    public static final String TYPE_IMAGE_SUPER_RESOLUTION = "type_image";
    public static final String TYPE_TEXT_SUPER_RESOLUTION = "type_text";
