...
package com.ClarifAI.main.sample.activity;
...
import com.ClarifAI.main.sample.src.codelab.awareness.BarrierActivity;
import com.ClarifAI.main.sample.src.codelab.awareness.CaptureActivity;
import com.ClarifAI.main.sample.util.Constant;
import com.huawei.agconnect.config.AGConnectServicesConfig;
import com.huawei.hms.mlsdk.common.MLApplication;
import com.huawei.mlkit.sample.R;
import com.ClarifAI.main.sample.activity.adapter.GridViewAdapter;
import com.ClarifAI.main.sample.activity.aft.AudioFileTranscriptionActivity;
import com.ClarifAI.main.sample.activity.asr.AsrAudioActivity;
import com.ClarifAI.main.sample.activity.asrlong.RealTimeTranscriptionActivity;
import com.ClarifAI.main.sample.activity.bcr.BankCardRecognitionActivity;
import com.ClarifAI.main.sample.activity.docdetection.RemoteDetectionActivity;
import com.ClarifAI.main.sample.activity.entity.GridViewItem;
import com.ClarifAI.main.sample.activity.gcr.GeneralCardRecognitionActivity;
import com.ClarifAI.main.sample.activity.icr.IDCardActivity;
import com.ClarifAI.main.sample.activity.ner.TextNerActivity;
import com.ClarifAI.main.sample.activity.si.activity.MainActivity;
import com.ClarifAI.main.sample.activity.sounddect.SoundDectActivity;
import com.ClarifAI.main.sample.activity.ocr.TextRecognitionActivity;
import com.ClarifAI.main.sample.activity.textemdding.TextEmbeddingActivity;
import com.ClarifAI.main.sample.activity.tts.TtsAnalyseActivity;
...
public final class StartActivity extends BaseActivity
    ...
    private static final int[] ICONS = {R.drawable.icon_classification, R.drawable.icon_asr ,R.drawable.icon_tts, R.drawable.icon_aft,
            R.drawable.icon_bcr, R.drawable.icon_gcr, R.drawable.icon_text, R.drawable.icon_icr,
            R.drawable.icon_document,R.drawable.icon_sound_dect,R.drawable.icon_textembedding,
            R.drawable.icon_asr_long_voice,R.drawable.icon_textembedding,R.drawable.icon_asr_long_voice,
            R.drawable.icon_translate, R.drawable.icon_face, R.drawable.icon_face};

    private static final int[] TITLES = {R.string.eyes_gpt, R.string.asr,R.string.tts, R.string.aft, R.string.bcr,
            R.string.gcr, R.string.text_detection, R.string.icr, R.string.document_recognition,
            R.string.sound_dect_title,R.string.textembedding,R.string.speechRtt,R.string.textNer,R.string.testSi,
            R.string.translate, R.string.settings, R.string.settings};
    ...
    private void initClickEvent() {
        ...
        this.mGridView.setOnItemClickListener((parent, view, position, id) -> {
            switch (position) {
                case 0:
                    // EyesGPT
                    startActivity(new Intent(StartActivity.this, EyesGPTActivity.class));
                    break;
                case 1:
                ...
                case 13:
                    ...
                    break;
                case 14:
                    startActivity(new Intent(StartActivity.this, com.ClarifAI.main.sample.vision.activity.StartActivity.class));
                    break;
                case 15:
                    // Barrier Activity
                    startActivity(new Intent(StartActivity.this, BarrierActivity.class));
                    break;
                case 16:
                    startActivity(new Intent(StartActivity.this, CaptureActivity.class));
                    break;
