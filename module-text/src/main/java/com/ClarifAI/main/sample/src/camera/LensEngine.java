...
package com.ClarifAI.main.sample.src.camera;
...
import com.ClarifAI.main.sample.src.transactor.ImageTransactor;
...
public class LensEngine {
    ...
    public void startRecording(String outputFilePath) {
        ...
        mediaRecorder.setOrientationHint(90); // Where rotation is the correct rotation degree.
        mediaRecorder.setOutputFile(outputFilePath);

//        int min = CameraConfiguration.DEFAULT_HEIGHT;
//        int max = CameraConfiguration.DEFAULT_WIDTH;
//
//        if (this.activity.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
//            mediaRecorder.setVideoSize(min, max);
//        } else {
//            mediaRecorder.setVideoSize(max, min);
//        }

        mediaRecorder.setVideoEncodingBitRate(5 * 1024 * 1024); // Example bitrate
